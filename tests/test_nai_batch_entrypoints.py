...
from astrbot_plugin_image_studio.tests.test_command_invocation import CommandEvent
from astrbot_plugin_image_studio.tests.test_nai_batches import Executor
