...
from astrbot_plugin_image_studio.backend.metadata.comfyui.graph import _workflow_graph
...
from astrbot_plugin_image_studio.tests.backend.comfyui.test_comfy_seed_warnings import (
    bind,
    definition,
)
...
def test_shared_widget_mapping_is_defensive_and_affects_parser_fingerprint(monkeypatch):
    ...
    monkeypatch.setattr(
        "astrbot_plugin_image_studio.backend.metadata.comfyui.user_rules.analysis_fingerprint",
