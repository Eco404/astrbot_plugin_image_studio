...
当前正式版本为 **1.3.2**。本版优化手机和平板的大图浏览，修复详情切图闪回和灯箱图片条跟随延迟，并统一插件日志接口。完整变化见 [更新记录](CHANGELOG.md)。
...
从旧版升级前，请停止 AstrBot 并备份完整插件数据目录。1.3.2 沿用正式 **v3 数据库**，从 1.3.0／1.3.1 或 1.3.2 开发版升级无需结构迁移；1.1.0／1.2.0 用户由 v2 升级，1.0.0 用户按 v1 → v2 → v3 升级。最终 `3-dev.1` 开发库可直接转换，保留已有工作流和任务数据。
