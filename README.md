...
当前正式版本为 **1.4.0**，完善 ComfyUI 工作流复现、文本节点识别和图组管理，并优化图片与数据库存储。安装包见 [Releases](https://github.com/Eco404/astrbot_plugin_image_studio/releases)，完整变化见 [更新记录](CHANGELOG.md)。
