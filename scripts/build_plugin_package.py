...
RUNTIME_FILES = (
    ...
    "backend/comfyui/rules/prompt_analysis.json",
...
REQUIRED_BACKEND_FILES = (
    ...
    "backend/gallery/constants.py",
    "backend/gallery/context.py",
    "backend/gallery/errors.py",
    "backend/gallery/external.py",
    "backend/gallery/external_records.py",
    "backend/gallery/imports.py",
    "backend/gallery/maintenance.py",
    "backend/gallery/metadata_records.py",
    "backend/gallery/projection.py",
    "backend/gallery/queries.py",
    "backend/gallery/records.py",
    "backend/gallery/store.py",
    "backend/gallery/storage.py",
    "backend/gallery/timestamps.py",
    "backend/generation/__init__.py",
    "backend/generation/concurrency.py",
    "backend/generation/comfyui_runtime.py",
    "backend/generation/service.py",
    "backend/metadata/__init__.py",
    "backend/metadata/common.py",
    "backend/metadata/readers.py",
    "backend/metadata/novelai.py",
    "backend/metadata/stable_diffusion.py",
    "backend/metadata/comfyui/__init__.py",
    "backend/metadata/comfyui/parser.py",
    "backend/metadata/comfyui/graph.py",
    "backend/metadata/comfyui/candidates.py",
    "backend/metadata/comfyui/evidence.py",
    "backend/metadata/comfyui/user_rules.py",
    "backend/media/__init__.py",
    "backend/media/files.py",
    "backend/media/display.py",
    "backend/media/images.py",
    "backend/parameters/__init__.py",
    "backend/parameters/exchange.py",
    "backend/metadata/parser.py",
    "backend/models.py",
    ...
    "backend/providers/comfyui/job_store.py",
    "backend/providers/comfyui/job_manager.py",
    "backend/providers/comfyui/job_files.py",
    "backend/providers/comfyui/job_types.py",
    "backend/providers/comfyui/storage.py",
    ...
    "backend/providers/http.py",
    "backend/providers/discovery.py",
    "backend/providers/openai_images.py",
    "backend/providers/gemini.py",
    "backend/providers/nai_direct.py",
    "backend/providers/custom_json.py",
    "backend/providers/novelai/__init__.py",
    "backend/providers/novelai/catalog.py",
    "backend/providers/novelai/client.py",
    "backend/providers/novelai/inpaint.py",
    "backend/providers/novelai/inputs.py",
    "backend/providers/novelai/protocol.py",
...
RUNTIME_DIRECTORIES = ("backend", "pages")
REQUIRED_ARCHIVE_FILES = (
    RUNTIME_FILES
    + REQUIRED_BACKEND_FILES
    + (
        "pages/image-studio/index.html",
        "pages/image-studio/comfyui/node-rules.js",
        "pages/image-studio/comfyui/node-rules.css",
        ...
        "pages/image-studio/gallery/controller.js",
        "pages/image-studio/components/presentation.js",
        "pages/image-studio/components/modal.js",
        "pages/image-studio/gallery/metadata.js",
        "pages/image-studio/gallery/metadata-markup.js",
        "pages/image-studio/gallery/imports.js",
        "pages/image-studio/settings/controller.js",
        "pages/image-studio/dialog-motion.js",
        "pages/image-studio/settings/external-sources.js",
        ...
        "pages/image-studio/media-objects.js",
    ...
    for directory_name in RUNTIME_DIRECTORIES:
        ...
        for path in directory.rglob("*"):
            ...
            if (
                ...
                and (directory_name != "backend" or path.suffix == ".py")
            ):
                selected.add(path)
