(function () {
  ...
  window.ImageStudioSettings = function (hooks) {
    ...
    function ensureToolConfig(model, provider) {
      ...
      if (official) Object.assign(defaults, { selection_description: "NovelAI 官方图像生成；参考用途以模型能力为准。", prompt_profile: "custom", prompt_instructions: novelaiModels.some(item => item.id === model.id) ? "使用英文逗号分隔标签，可结合自然语言补充关系与动作；保留用户明确指定的内容。" : "优先使用英文逗号分隔标签；其他提示词格式请按所用模型的说明配置。" });
