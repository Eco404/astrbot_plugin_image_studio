(function () {
  ...
  window.ImageStudioNovelAI = function ({ state, model: selectedModel, escape, rerenderReferences, uploadFile, openModal, showNotice }) {
    ...
    function parameter(name, descriptor, current) {
      ...
      return `<section class="field field-wide novelai-characters" data-novelai-characters>${hidden}<div class="field-label-row"><label>多角色提示词</label><button type="button" class="quiet-button" data-novelai-character-add>添加角色</button></div><span class="field-hint" data-novelai-character-hint></span><div data-novelai-character-list></div></section>`;
    }
