(function () {
  ...
  const { own, serial, icon, renderIcons, modeLabel, engineLabel, engineOf, setCommandLabel, positionBalancedGrid } = window.ImageStudioPresentation;
